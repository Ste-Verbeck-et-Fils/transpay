...
const Scan = () => {
    ...
    // Get selected trajet data from previous page if available
    ...
    const handleIdentification = async (identifier) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5000/api/bus/identify", {
                method: "POST",
                headers: {
            ...
            if (data.success) {
                // Navigate to payment with bus details and selected trajet
                navigate("/paiement", { 
                    state: { 
                        bus: data.data,
        ...
        <div className="scan-page">
            ...
            <main className="scan-container">
                ...
                <div className="scanner-box">
                    <img src={scanBusImg} alt="Bus identification" className="scanner-bg" />
