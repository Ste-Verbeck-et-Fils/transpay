  ...
  return (
    <div className="home-container">
      ...
      <main className="home-main">
        {/* Hero Section */}
        <section className="hero-section" style={{ backgroundImage: `url("${busHero}")` }}>
           <div className="hero-overlay">
              <div className="hero-content">
                <h1>Kinetic Precision for Goma</h1>
                <p>Simplifiez vos déplacements urbains avec le système de paiement le plus sécurisé et le plus rapide du Congo.</p>
              </div>
           </div>
        </section>
        ...
        <div className="features-wrapper">
            <section className="features-grid">
                ...
                <div className="feature-card white-card recharge-card">
                    ...
                    <h3>Recharger</h3>
                    <p>Approvisionnez votre compte instantanément via Mobile Money ou Carte.</p>
                ...
                <div className="feature-card orange-card rapid-payment">
                    <div className="card-info">
                        <h3>Rapid payment</h3>
                        <p>Scannez le code QR à bord pour payer en moins de 2 secondes.</p>
                        <div className="card-action">
                            <button className="btn-custom btn-white">Scanner QR</button>
                        </div>
                    </div>
                    <div className="qr-graphic">
                        <img src={scanBus} alt="QR Code" className="qr-img" />
                    </div>
                </div>
            ...
            <div className="chauffeur-wrapper">
                <div className="chauffeur-content">
                    <div className="chauffeur-text">
                        <h2>Chauffeur ?</h2>
                        <p>Rejoignez la révolution de la mobilité à Goma. Gérez vos recettes en temps réel et sécurisez vos gains quotidiens sans manipuler d'espèces.</p>
                        <div className="chauffeur-actions">
                            <Button text="DEVENIR PARTENAIRE" variant="primary" className="chauffeur-btn" />
                            <button className="btn-custom btn-white chauffeur-btn">EN SAVOIR PLUS</button>
                        </div>
                    </div>
                    <div className="chauffeur-image-container">
                        <img src={taxiChauffeur} alt="Chauffeur" className="chauffeur-img" />
                    </div>
                </div>
            </div>
        </section>
